...
export const MONSTERS = [
  ...
  // CB 1–39  (18 monstros)
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'chickens',      name: 'Chickens',      tier: 'cb1',  minCB: 1,  coinsPerKill: 1, bonusEvery: 100, bonusAmount: 15, img: `${WIKI_IMG}/Chicken.png`,                slayerReq: false, wiki: `${WIKI_PAGE}/Chicken` },
  ...
  { id: 'bears',         name: 'Bears',          tier: 'cb1',  minCB: 8,  coinsPerKill: 1, bonusEvery: 100, bonusAmount: 15, img: `${WIKI_IMG}/Bear.png`,                   slayerReq: false, wiki: `${WIKI_PAGE}/Bear` },
  ...
  { id: 'zombies_mid',      name: 'Zombies',          tier: 'cb40', minCB: 40, coinsPerKill: 5, bonusEvery: 75, bonusAmount: 50, img: `${WIKI_IMG}/Zombie_(blue).png`,                 slayerReq: false, wiki: `${WIKI_PAGE}/Zombie` },
  ...
  { id: 'bandits',          name: 'Bandits',          tier: 'cb40', minCB: 40, coinsPerKill: 5, bonusEvery: 75, bonusAmount: 50, img: `${WIKI_IMG}/Bandit_(Kharidian_Desert).png`,     slayerReq: false, wiki: `${WIKI_PAGE}/Bandit_(Kharidian_Desert)` },
  ...
  { id: 'cave_crawlers',    name: 'Cave Crawlers',    tier: 'cb40', minCB: 40, coinsPerKill: 5, bonusEvery: 75, bonusAmount: 50, img: `${WIKI_IMG}/Cave_crawler.png`,                  slayerReq: true,  wiki: `${WIKI_PAGE}/Cave_crawler` },
  ...
  { id: 'dagannoths',     name: 'Dagannoths',     tier: 'cb70', minCB: 70, coinsPerKill: 12, bonusEvery: 40, bonusAmount: 100, img: `${WIKI_IMG}/Dagannoth_(Waterbirth_Island).png`, slayerReq: false, wiki: `${WIKI_PAGE}/Dagannoth` },
  ...
  { id: 'cave_horrors',   name: 'Cave Horrors',   tier: 'cb70', minCB: 70, coinsPerKill: 12, bonusEvery: 40, bonusAmount: 100, img: `${WIKI_IMG}/Cave_horror.png`,              slayerReq: true,  wiki: `${WIKI_PAGE}/Cave_horror` },
  ...
  { id: 'turoth',         name: 'Turoth',         tier: 'cb70', minCB: 70, coinsPerKill: 12, bonusEvery: 40, bonusAmount: 100, img: `${WIKI_IMG}/Turoth.png`,                   slayerReq: true,  wiki: `${WIKI_PAGE}/Turoth` },
  ...
  { id: 'spiritual_mages',      name: 'Spiritual Mages',      tier: 'cb90', minCB: 90, coinsPerKill: 20, bonusEvery: 20, bonusAmount: 180, img: `${WIKI_IMG}/Spiritual_mage_(Zamorak).png`, slayerReq: true, wiki: `${WIKI_PAGE}/Spiritual_mage` },
  ...
  { id: 'alchemical_hydra',      name: 'Alchemical Hydra',      tier: 'boss', minCB: 95, coinsPerKill: 140, bonusEvery: 5, bonusAmount: 550, img: `${WIKI_IMG}/Alchemical_Hydra.png`,          slayerReq: true,  wiki: `${WIKI_PAGE}/Alchemical_Hydra` },
]
